...
const ORDER: OrderDetails = {
    merchant: "EZVote EMS",
    description: "Upgrade for Pro Plan subscription",
    amount: 15000,
    currency: "₱",
    refNo: "URP-84213-PH",
};
...
const CHANNELS: PaymentChannel[] = [
    {
        ...
        accountName: "Jan Liby Dela Costa",
        accountNumber: "0997 695 3621",
        ...
        return (
            <div className="min-h-screen w-full bg-background sm:bg-muted/40 flex items-center justify-center py-4 px-4 sm:py-6">
                <div className="w-full max-w-xl sm:border sm:bg-background sm:rounded-xl sm:shadow-lg text-center p-4 md:p-10 flex flex-col items-center justify-center">
                    ...
                    <Button type="submit" size="lg" variant="outline" className="w-fit font-medium">
                                ...
                                {CHANNELS.map((c) => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`flex flex-row sm:flex-col items-center sm:justify-center gap-3 sm:gap-1.5 p-3 rounded-xl border text-left sm:text-center transition-all ${isSelected
                        ...
                        <div className="space-y-2">
                            ...
                            {!file ? (
                                <button
                                    ...
                                    onDrop={onDrop}
                                    className={`w-full rounded-xl px-4 py-6 md:py-8 flex flex-col items-center gap-2 text-center transition-colors border border-dashed ${dragOver ? "bg-primary/5 border-primary" : "bg-muted/40 hover:bg-muted/70 border-input"
                                        }`}
                                >
